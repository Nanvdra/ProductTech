const items = [
    { name: "Laptop", description: "A portable computer.", image: "lp.jpeg"},
    ...
    { name: "Television", description: "A telecommunications medium for transmitting moving images and sound", image: "televisi.jpeg"}
];
